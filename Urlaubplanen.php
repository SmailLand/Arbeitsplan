...
$urlaubsql = "INSERT INTO arbeitsplan (PersNr, Datum, Stunden, anmerkung)
VALUES('$Personalnummer', '$datumfromform', '8', 'U')";
$result = $mysqli->query($urlaubsql);
...
header("Location: planansicht.php");
	...
	If(empty($anmerkung)){
		$sql = "Update arbeitsplan Set anmerkung = 'U' Where PersNr Like '".$Personalnummer."' AND Datum LIKE '".$datumfromform."' ";
