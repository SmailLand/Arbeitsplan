...
<form class="form-horizontal" action="Urlaubplanen.php">
<fieldset>

<!-- Form Name -->
<legend><h1>Datum auswählen für den Urlaubstag:</h1></legend>
...
<div class="form-group">
  ...
  <span class="help-block">geben Sie das Datum ein, an dem Sie einen Urlaubtag haben wollen</span>  
  </div>
</div>
