...
<form class="form-horizontal" action="Stundenplanen.php">
<fieldset>

<!-- Form Name -->
<legend><h1>Datum auswählen für den Arbeitstag:</h1></legend>
...
<div class="form-group">
  ...
  <span class="help-block">geben Sie das Datum ein, an dem Sie arbeiten wollen</span>  
  </div>
</div>
